...
let esm_dirname;
try {
  esm_dirname = (0,external_url_namespaceObject.fileURLToPath)(import.meta.url);
} catch (e) {
...
;// CONCATENATED MODULE: ./src/commands/generateComponent/generateComponentBuilder.ts
...
;// CONCATENATED MODULE: ./src/commands/generateComponent/generateComponentHandler.ts
function generateComponentHandler(args) {
    console.log("args", args);
}

;// CONCATENATED MODULE: ./src/commands/generateComponent/index.ts


const GENERATE_COMPONENT_SCRIPT = "generate-component [name]";
const GENERATE_COMPONENT_DESCRIPTION = "Generate react component directory";
...
/* harmony default export */ const commands = ([generateComponent]);
